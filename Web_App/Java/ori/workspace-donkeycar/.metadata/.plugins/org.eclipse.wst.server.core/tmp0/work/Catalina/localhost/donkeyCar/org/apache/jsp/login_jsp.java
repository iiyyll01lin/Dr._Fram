 ...
 * Generated at: 2021-02-13 15:33:57 UTC
...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<i class=\"fas fa-sign-in-alt\"></i> 登入\r\n");
      out.write("\t\t\t\t\t</h1>\r\n");
      out.write("\t\t\t\t\t<form action=\"");
      out.print(request.getContextPath());
      out.write("/login\" method=\"POST\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"email\">使用者帳號</label> \r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"email\" id=\"email\"\r\n");
      out.write("\t\t\t\t\t\t\t\tname=\"email\" class=\"form-control\" placeholder=\"Enter Email Account\" />\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"password\">密碼</label> <input type=\"password\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"password\" name=\"password\" class=\"form-control\"\r\n");
      out.write("\t\t\t\t\t\t\t\tplaceholder=\"Enter Password\" />\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-primary btn-block\">登入</button>\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t<p class=\"lead mt-4\">\r\n");
      out.write("\t\t\t\t\t\t還沒有帳號? <a href=\"registration.jsp\">註冊</a>\r\n");
      out.write("\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
